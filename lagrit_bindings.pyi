...
class MeshObject:
    ...
    def attr_list(self) -> typing.List[typing.Dict[str, str]]: ...
    def pset_names(self) -> typing.List[str]: ...
    def eltset_names(self) -> typing.List[str]: ...
    def dump(self, file_path: str): ...

class LgCmdWithInput:
    def with_input(self, input: str) -> LgCmdWithInput: ...
    def sendcmd(self, cmd: str): ...

class LgCmdWithOutput:
    def sendcmd(self, cmd: str): ...
...
class LaGriT:
    ...
    def with_input(self, input: str) -> LgCmdWithInput: ...
    def with_output(self, output: str) -> LgCmdWithOutput: ...
    def sendcmd(self, cmd: str): ...
    def cmdmsg(self) -> str: ...
    def mo_names(self) -> typing.List[str]: ...
    def pset_names(self) -> typing.List[str]: ...
    def eltset_names(self) -> typing.List[str]: ...
    def get_mo(self, name: typing.Optional[str]) -> MeshObject: ...
    def read_mo(
        self, file_path: str, name: typing.Optional[str]
    ) -> typing.List[MeshObject]: ...
    def dump_mo(self, file_path: str, mo: typing.Optional[MeshObject]): ...
    def close(self): ...
